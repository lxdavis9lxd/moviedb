...
var NavigationMenu = React18.forwardRef(
  (props, forwardedRef) => {
    const {
    ...
    const [navigationMenu, setNavigationMenu] = React18.useState(null);
    ...
    const startCloseTimer = React18.useCallback(() => {
...
var NavigationMenuSub = React18.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeNavigationMenu,
      value: valueProp,
    ...
    return (0, import_jsx_runtime10.jsx)(
      NavigationMenuProvider,
      {
        ...
        onItemDismiss: () => setValue(""),
        children: (0, import_jsx_runtime10.jsx)(Primitive.div, { "data-orientation": orientation, ...subProps, ref: forwardedRef })
      }
    );
  }
);
...
var NavigationMenuProvider = (props) => {
  ...
  const [viewportContent, setViewportContent] = React18.useState(/* @__PURE__ */ new Map());
  const [indicatorTrack, setIndicatorTrack] = React18.useState(null);
  return (0, import_jsx_runtime10.jsx)(
    NavigationMenuProviderImpl,
    {
      ...
      onViewportContentChange: React18.useCallback((contentValue, contentData) => {
        setViewportContent((prevContent) => {
          prevContent.set(contentValue, contentData);
          return new Map(prevContent);
        });
      }, []),
      onViewportContentRemove: React18.useCallback((contentValue) => {
        setViewportContent((prevContent) => {
      ...
      children: (0, import_jsx_runtime10.jsx)(Collection.Provider, { scope, children: (0, import_jsx_runtime10.jsx)(ViewportContentProvider, { scope, items: viewportContent, children }) })
    }
  );
};
var LIST_NAME = "NavigationMenuList";
var NavigationMenuList = React18.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, ...listProps } = props;
    const context = useNavigationMenuContext(LIST_NAME, __scopeNavigationMenu);
    const list = (0, import_jsx_runtime10.jsx)(Primitive.ul, { "data-orientation": context.orientation, ...listProps, ref: forwardedRef });
    return (0, import_jsx_runtime10.jsx)(Primitive.div, { style: { position: "relative" }, ref: context.onIndicatorTrackChange, children: (0, import_jsx_runtime10.jsx)(Collection.Slot, { scope: __scopeNavigationMenu, children: context.isRootMenu ? (0, import_jsx_runtime10.jsx)(FocusGroup, { asChild: true, children: list }) : list }) });
  }
);
NavigationMenuList.displayName = LIST_NAME;
var ITEM_NAME = "NavigationMenuItem";
var [NavigationMenuItemContextProvider, useNavigationMenuItemContext] = createNavigationMenuContext(ITEM_NAME);
var NavigationMenuItem = React18.forwardRef(
  (props, forwardedRef) => {
    ...
    const focusProxyRef = React18.useRef(null);
    const restoreContentTabOrderRef = React18.useRef(() => {
    });
    const wasEscapeCloseRef = React18.useRef(false);
    const handleContentEntry = React18.useCallback((side = "start") => {
    ...
    const handleContentExit = React18.useCallback(() => {
      if (contentRef.current) {
        const candidates = getTabbableCandidates(contentRef.current);
    ...
    return (0, import_jsx_runtime10.jsx)(
      NavigationMenuItemContextProvider,
      {
        ...
        children: (0, import_jsx_runtime10.jsx)(Primitive.li, { ...itemProps, ref: forwardedRef })
      }
    );
  }
);
...
var NavigationMenuTrigger = React18.forwardRef((props, forwardedRef) => {
  ...
  const wasClickCloseRef = React18.useRef(false);
  const open = itemContext.value === context.value;
  return (0, import_jsx_runtime10.jsxs)(import_jsx_runtime10.Fragment, { children: [
    (0, import_jsx_runtime10.jsx)(Collection.ItemSlot, { scope: __scopeNavigationMenu, value: itemContext.value, children: (0, import_jsx_runtime10.jsx)(FocusGroupItem, { asChild: true, children: (0, import_jsx_runtime10.jsx)(
      Primitive.button,
      {
        id: triggerId,
        disabled,
    ...
    open && (0, import_jsx_runtime10.jsxs)(import_jsx_runtime10.Fragment, { children: [
      ...
      context.viewport && (0, import_jsx_runtime10.jsx)("span", { "aria-owns": contentId })
    ] })
  ] });
});
...
var NavigationMenuLink = React18.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, active, onSelect, ...linkProps } = props;
    return (0, import_jsx_runtime10.jsx)(FocusGroupItem, { asChild: true, children: (0, import_jsx_runtime10.jsx)(
      Primitive.a,
      {
...
var NavigationMenuIndicator = React18.forwardRef((props, forwardedRef) => {
  const { forceMount, ...indicatorProps } = props;
  const context = useNavigationMenuContext(INDICATOR_NAME, props.__scopeNavigationMenu);
  const isVisible = Boolean(context.value);
  return context.indicatorTrack ? import_react_dom.default.createPortal(
    (0, import_jsx_runtime10.jsx)(Presence, { present: forceMount || isVisible, children: (0, import_jsx_runtime10.jsx)(NavigationMenuIndicatorImpl, { ...indicatorProps, ref: forwardedRef }) }),
    context.indicatorTrack
  ) : null;
});
NavigationMenuIndicator.displayName = INDICATOR_NAME;
var NavigationMenuIndicatorImpl = React18.forwardRef((props, forwardedRef) => {
  const { __scopeNavigationMenu, ...indicatorProps } = props;
  const context = useNavigationMenuContext(INDICATOR_NAME, __scopeNavigationMenu);
  const getItems = useCollection(__scopeNavigationMenu);
  const [activeTrigger, setActiveTrigger] = React18.useState(
    null
  );
  const [position, setPosition] = React18.useState(null);
  ...
  return position ? (0, import_jsx_runtime10.jsx)(
    Primitive.div,
    {
      "aria-hidden": true,
...
var NavigationMenuContent = React18.forwardRef((props, forwardedRef) => {
  ...
  return !context.viewport ? (0, import_jsx_runtime10.jsx)(Presence, { present: forceMount || open, children: (0, import_jsx_runtime10.jsx)(
  ...
  ) }) : (0, import_jsx_runtime10.jsx)(ViewportContentMounter, { forceMount, ...commonProps, ref: composedRefs });
});
NavigationMenuContent.displayName = CONTENT_NAME;
var ViewportContentMounter = React18.forwardRef((props, forwardedRef) => {
  const context = useNavigationMenuContext(CONTENT_NAME, props.__scopeNavigationMenu);
...
var NavigationMenuContentImpl = React18.forwardRef((props, forwardedRef) => {
  const {
    __scopeNavigationMenu,
    value,
    triggerRef,
  ...
  const getItems = useCollection(__scopeNavigationMenu);
  const prevMotionAttributeRef = React18.useRef(null);
  ...
  const motionAttribute = React18.useMemo(() => {
    const items = getItems();
  ...
  return (0, import_jsx_runtime10.jsx)(FocusGroup, { asChild: true, children: (0, import_jsx_runtime10.jsx)(
    DismissableLayer,
    {
      id: contentId,
...
var NavigationMenuViewport = React18.forwardRef((props, forwardedRef) => {
  const { forceMount, ...viewportProps } = props;
  const context = useNavigationMenuContext(VIEWPORT_NAME, props.__scopeNavigationMenu);
  const open = Boolean(context.value);
  return (0, import_jsx_runtime10.jsx)(Presence, { present: forceMount || open, children: (0, import_jsx_runtime10.jsx)(NavigationMenuViewportImpl, { ...viewportProps, ref: forwardedRef }) });
});
NavigationMenuViewport.displayName = VIEWPORT_NAME;
var NavigationMenuViewportImpl = React18.forwardRef((props, forwardedRef) => {
  ...
  const [size, setSize] = React18.useState(null);
  ...
  return (0, import_jsx_runtime10.jsx)(
    Primitive.div,
    {
      ...
      children: Array.from(viewportContentContext.items).map(([value, { ref, forceMount, ...props2 }]) => {
        ...
        return (0, import_jsx_runtime10.jsx)(Presence, { present: forceMount || isActive, children: (0, import_jsx_runtime10.jsx)(
          NavigationMenuContentImpl,
          {
            ...props2,
...
var FocusGroup = React18.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, ...groupProps } = props;
    const context = useNavigationMenuContext(FOCUS_GROUP_NAME, __scopeNavigationMenu);
    return (0, import_jsx_runtime10.jsx)(FocusGroupCollection.Provider, { scope: __scopeNavigationMenu, children: (0, import_jsx_runtime10.jsx)(FocusGroupCollection.Slot, { scope: __scopeNavigationMenu, children: (0, import_jsx_runtime10.jsx)(Primitive.div, { dir: context.dir, ...groupProps, ref: forwardedRef }) }) });
  }
);
var ARROW_KEYS = ["ArrowRight", "ArrowLeft", "ArrowUp", "ArrowDown"];
var FOCUS_GROUP_ITEM_NAME = "FocusGroupItem";
var FocusGroupItem = React18.forwardRef(
  (props, forwardedRef) => {
    const { __scopeNavigationMenu, ...groupProps } = props;
    const getItems = useFocusGroupCollection(__scopeNavigationMenu);
    const context = useNavigationMenuContext(FOCUS_GROUP_ITEM_NAME, __scopeNavigationMenu);
    return (0, import_jsx_runtime10.jsx)(FocusGroupCollection.ItemSlot, { scope: __scopeNavigationMenu, children: (0, import_jsx_runtime10.jsx)(
      Primitive.button,
      {
        ...groupProps,
        ref: forwardedRef,
